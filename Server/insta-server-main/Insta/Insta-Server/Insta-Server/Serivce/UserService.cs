...
namespace Insta_Server.Serivce
{
    public class UserService
    {
        ...
        public static List<FollowInforDTO> getFollowingUser(string user_id, string view_id)
        {
            ...
            {
                foreach (string g in generalList)
                {
                    if (f.UserId.Equals(g))
                    {
                        f.flag = true;
        ...
        public List<string> getGeneralFollow(string user1, string user2)
        {
        ...
        public static bool register(UserRegisterDTO userRegisterDTO)
        {
            ...
            try
            {
                ...
                person.Status = 1;
                person.PhotoId = context.Photos.ToList().Count;
        ...
        public static List<UserInforDTO> SearchUser(string user_id)
        {
            InstaContext context = new InstaContext();
            List<Person> people = context.People.Where(x => x.Username.ToLower().Contains(user_id.ToLower())).ToList();
