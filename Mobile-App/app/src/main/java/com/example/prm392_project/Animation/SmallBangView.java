package com.example.prm392_project.Animation;
...
public class SmallBangView extends FrameLayout {
    ...
    public SmallBangView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int dotPrimaryColor = array.getColor(R.styleable.SmallBangView_dots_primary_color, vDotsView.COLOR_1);
        int dotSecondaryColor = array.getColor(R.styleable.SmallBangView_dots_secondary_color, vDotsView.COLOR_2);
        ...
        vDotsView = new DotView(getContext());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.AT_MOST || widthMode == MeasureSpec.UNSPECIFIED) {
            width = (int) (iconSize * 1.5f);
        }
        if (heightMode == MeasureSpec.AT_MOST || heightMode == MeasureSpec.UNSPECIFIED) {
            height = (int) (iconSize * 1.5f);
        }
    ...
    private boolean isScaleView(View child) {
        return child != null && !(child instanceof DotView) && !(child instanceof CircleView);
    }
    ...
    public void likeAnimation(Animator.AnimatorListener listener) {
        ...
        ObjectAnimator dotsAnimator = ObjectAnimator.ofFloat(vDotsView, DotView.DOTS_PROGRESS, 0f, 1f);
