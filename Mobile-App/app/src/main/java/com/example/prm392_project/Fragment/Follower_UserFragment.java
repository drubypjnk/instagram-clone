...
public class Follower_UserFragment extends Fragment implements FriendlistAdapter.ButtonItemListener {
    private int pcurr;
    ...
    String current_user;
    public Follower_UserFragment(String person_id) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //get follower
        ApiService.apiService.getFollowerUser(person_id,current_user).enqueue(new Callback<List<FollowInforDTO>>() {
            @Override
            public void onResponse(Call<List<FollowInforDTO>> call, Response<List<FollowInforDTO>> response) {
                listFollower=response.body();
                Action(view);
            }
