...
public class DotView extends View {
    public static final Property<DotView, Float> DOTS_PROGRESS = new Property<DotView, Float>(Float.class, "dotsProgress") {
        @Override
        public Float get(DotView object) {
            return object.getCurrentProgress();
        }

        @Override
        public void set(DotView object, Float value) {
